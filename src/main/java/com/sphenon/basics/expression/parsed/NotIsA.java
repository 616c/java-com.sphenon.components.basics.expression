...
public class NotIsA extends ExpressionBase {
    ...
    public NotIsA (CallContext context, Expression c1, Expression c2) {
        this(context, c1, c2, -1, -1);
    }

    public NotIsA (CallContext context, Expression c1, Expression c2, int lower_limit, int upper_limit) {
        super(context);
        this.c1 = c1;
        this.c2 = c2;
    ...
    public Object getValue(CallContext context, Scope scope) throws EvaluationFailure {
        if (c1 instanceof Array) {
            ...
            return (false == isA(context, c1, c2, scope));
        }
    }
