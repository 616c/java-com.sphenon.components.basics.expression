...
public class ExpressionStringPool extends StringPoolClass {
    static protected ExpressionStringPool singleton = null;

    static public ExpressionStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new ExpressionStringPool(cc);
        }
        return singleton;
    }
    ...
    protected ExpressionStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
