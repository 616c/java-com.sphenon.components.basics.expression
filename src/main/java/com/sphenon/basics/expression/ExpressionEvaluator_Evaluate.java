...
public class ExpressionEvaluator_Evaluate implements ExpressionEvaluator {

    public ExpressionEvaluator_Evaluate (CallContext context) {
    ...
    public Object evaluate(CallContext context, String string, Scope scope, DataSink<Execution> execution_sink) throws EvaluationFailure {
        return Expression.evaluate(context, string, scope, execution_sink);
    }
